...
## 1  Conceptual Survey: “Thinking Musically” across Discourses

| Ontological lens | Core proposition | Pedagogical implication | Key source |
|---|---|---|---|
| **Analytic philosophy** | A musical work is an *abstract type* tokened in performance; scores and sounds are contingent carriers[1][2]. | Students can debate the “work-versus-performance” status of a glockenspiel transcription, sharpening critical listening. | 3  33 |
| **Critical / enactive ontology** | Musical knowledge is *autopoietic*: it self-organises through bodily interaction with sonic environments[3][4]. | Lesson design must privilege participatory, improvisatory acts where learners co-constitute meaning. | 34  40 |
| **Embodied/4E cognition** | Sense-making is **Embodied, Embedded, Enacted, Extended**; movement, affordances and tool use form the musical mind[5][6][7]. | Mallet grip, damping, stance and spatial navigation on a C5–C8 keyboard are cognitive as well as technical tasks. | 17  20  56 |
| **Phenomenology** | Musical understanding is the *lived experience* of sound-in-time; gesture bridges perception and expression[8][9][10]. | Integrate eurhythmic walking, arm choreography and “air-malleting” before striking the bars. | 19  52  55 |
| **Neuroscience / developmental psychology** | Multimodal training enlarges auditory cortex and executive function; sensorimotor–auditory practice outperforms listening alone[11][12][13]. | Structure sessions so that every new pattern is *sung, moved, played, notated, improvised* – a full multimodal loop. | 8  18  26 |
| **Multisensory & HCI research** | Hybrid digital–acoustic ecosystems (IoMusT) foster non-linear, inclusive music learning[14][15]. | Optional extensions can link glockenspiel bars to lighting or haptic feedback for diverse learners. | 29  32 |
| **Music-education methodologies** | Kodály, Dalcroze, Orff and Brainin all treat musical thinking as a triad of *aural, kinesthetic and imaginative* processes[16][17]. | Anchor each lesson in singing, bodily flow and improvisation before formal notation. | 4  12 |
| **Somatic arts-medicine** | Conscious alignment and micro-movement (“Timani”) reduce pain and increase control[18]. | Include micro-breaks and body-mapping cues when practicing rapid C7-C8 passages. | 24 |

## 2  Unit Outline – *Thinking Musically through the 37-Tone Glockenspiel*

### 2.1  Overview  

*Duration* : 6 × 90-minute sessions (upper-secondary, tertiary or advanced community).  
*Equipment* : 37-tone glockenspiel (C5–C8) with damper pedal[19]; two pairs of contrasting mallets; projector/audio; floor space.  
*Unit goal* : Learners will **demonstrate and articulate “thinking musically”** by (a) embodying technical-expressive control over the full range, (b) improvising and composing idiomatic miniatures, and (c) critiquing the ontological status of their own performances.

### 2.2  Lesson Sequence  

| # | Focus & ontological pivot | Core activities | Assessment evidence |
|---|---|---|---|
| 1 | **Sonic Ontology** – “Where does the note live?” (type/token debate) | -  Guided listening to bell excerpts; map perceived *density* across C5–C8.<br>-  Spectrographic visualisation; discuss why notated C5 can sound “harder” than C6. | Annotated *sound-map* poster linking pitch, brightness, emotional valence. |
| 2 | **Embodied Entraining** – Dalcroze paths & whole-body range mapping | -  Walk glissandi up to C8 while chanting sol-fa.[17]<br>-  Pair exercise: student A moves arm-trajectory, student B shadows on glockenspiel. | Peer feedback rubric on *spatial accuracy & flow*. |
| 3 | **Gesture & Materiality** – Technique as cognition | -  Masterclass clips (Suchocka)[20] analyse wrist vs. finger initiation.<br>-  Timani micro-alignment drills: scapular release before damped strikes[18]. | 45-second *technical étude* video demonstrating three attack gestures. |
| 4 | **Improvising Ontic Layers** – Modal mixture & resonance | -  Borrow Aeolian ♭VI–♭VII to colour C-major patterns on high register[21][22].<br>-  Record and overlay two takes: damped vs. pedal-open; reflect on “work” identity. | Audio diary comparing *two ontic versions* of the same motive. |
| 5 | **Critical Seminar** – What is a “piece” for solo glockenspiel? | -  Read excerpts from type theory[2] and enactive critique[3].<br>-  Fish-bowl debate: Is a recorded improvisation a new work or a token? | Position paper (500 w) citing at least two ontological frameworks. |
| 6 | **Recital & Reflexivity** – Performance as research | -  Curate 3-minute solo per learner, integrating range extremes.<br>-  Audience completes “Embodied Listening” checklist (gesture, timbre, form). | Tri-fold portfolio: score/video, audience data, self-reflection. |

### 2.3  Alignment & Differentiation  
...
[34] Educator Resources: Make time for music - the glockenspiel used in ... https://ecdefenceprograms.com/modules/mod/page/view.php?id=1023
